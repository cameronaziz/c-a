...
const SVGIcon = ({ size, fill }) => (
  ...
  >
    <defs>
      <g id="SVG" fill={fill || '#fff'} transform="scale(2) translate(20,79)">
    ...
    <path id="base" fill={fill || '#000'} d="M8.5,150 H291.5 V250 C291.5,273.5 273.5,291.5 250,291.5 H50 C26.5,291.5 8.5,273.5 8.5,250 Z" />
    <g strokeWidth="38" stroke={fill || '#000'}>
      <g id="svgstar" transform="translate(150, 150)">
        <path id="svgbar" fill={fill || '#ffb13b'} d="M-84.1487,-15.8513 a22.4171,22.4171 0 1 0 0,31.7026 h168.2974 a22.4171,22.4171 0 1 0 0,-31.7026 Z" />
